...
> Make sure you have the correct dependencies installed
	> Install dependencies using pip MacOS, Linux, Commpand prompt: 
	`pip3 install flask pip3 install whoosh`
	> Windows Powershell: 
	`python3 -m pip install flask python3 -m pip install whoosh`
